                                    ...
                                    {data?.TaskListData?.map((data: any, index: any) =>
                                        <TableRow key={index}
                                            ...
                                            {TaskListHeaders?.find((data: any) => data?.ColumnName === 'StartDate') &&
                                                <TableCell >
                                                    {helper.converttoDateFormat(data?.StartDate, "DD/MM/YYYY")}
                                                </TableCell>
                                            }
                                            {TaskListHeaders?.find((data: any) => data?.ColumnName === 'EndDate') &&
                                                <TableCell >
                                                    {helper.converttoDateFormat(data?.EndDate, "DD/MM/YYYY")}
                                                </TableCell>
                                            }
                                            ...
                                            {TaskListHeaders?.find((data: any) => data?.ColumnName === 'CreatedDate') &&
                                                <TableCell >
                                                    {helper.converttoDateFormat(data?.CreatedDate, "DD/MM/YYYY")}
                                                </TableCell>
                                            }
